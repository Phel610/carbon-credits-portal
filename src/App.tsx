...
import ScenariosTrash from "./pages/financial/ScenariosTrash";
      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/financial/models/:id/inputs" element={
              <ProtectedRoute>
                <ModelInputs />
              </ProtectedRoute>
            } />
            ...
            <Route path="/financial/models/:id/reports" element={
              <ProtectedRoute>
                <ModelReports />
              </ProtectedRoute>
            } />
            ...
            <Route path="/financial/models/:id/scenarios/trash" element={
              <ProtectedRoute>
                <ScenariosTrash />
              </ProtectedRoute>
            } />
